...
const may2026Overrides: Record<string, DayOverride> = {
  ...
  '2026-05-04': { am: '찬우', pm: '이진', comment: '주설비' },
  '2026-05-05': { isOff: true, comment: '어린이날' },
